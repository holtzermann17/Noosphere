...
CREATE TABLE `acl_default` (
  ...
  PRIMARY KEY  (`uid`),
  KEY `userid` (`userid`)
) ENGINE=MyISAM AUTO_INCREMENT=46306 DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `acl_uid_seq` (
  `val` int(11) NOT NULL auto_increment,
  PRIMARY KEY  (`val`)
) ENGINE=MyISAM AUTO_INCREMENT=42969 DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `corrections_uid_seq` (
  `val` int(11) NOT NULL auto_increment,
  PRIMARY KEY  (`val`)
) ENGINE=MyISAM AUTO_INCREMENT=14592 DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `groups_groupid_seq` (
  `val` int(11) NOT NULL auto_increment,
  PRIMARY KEY  (`val`)
) ENGINE=MyISAM AUTO_INCREMENT=23498 DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `hits` (
  ...
  PRIMARY KEY  (`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=46754703 DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `inv_phrases` (
  ...
  PRIMARY KEY  (`id`),
  KEY `phrase` (`phrase`)
) ENGINE=MyISAM AUTO_INCREMENT=563604 DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;
...
) ENGINE=MyISAM AUTO_INCREMENT=154730 DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `mail_uid_seq` (
  `val` int(11) NOT NULL auto_increment,
  PRIMARY KEY  (`val`)
) ENGINE=MyISAM AUTO_INCREMENT=10572 DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `messages_uid_seq` (
  `val` int(11) NOT NULL auto_increment,
  PRIMARY KEY  (`val`)
) ENGINE=MyISAM AUTO_INCREMENT=21702 DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `notices_uid_seq` (
  `val` int(11) NOT NULL auto_increment,
  PRIMARY KEY  (`val`)
) ENGINE=MyISAM AUTO_INCREMENT=60208 DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `object_rating` (
  ...
  PRIMARY KEY  (`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=11568 DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `objects_uid_seq` (
  `val` int(11) NOT NULL auto_increment,
  PRIMARY KEY  (`val`)
) ENGINE=MyISAM AUTO_INCREMENT=11682 DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;
...
) ENGINE=MyISAM AUTO_INCREMENT=98283 DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `requests_uid_seq` (
  `val` int(11) NOT NULL auto_increment,
  PRIMARY KEY  (`val`)
) ENGINE=MyISAM AUTO_INCREMENT=914 DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;
...
) ENGINE=MyISAM AUTO_INCREMENT=107741 DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `users_uid_seq` (
  `val` int(11) NOT NULL auto_increment,
  PRIMARY KEY  (`val`)
) ENGINE=MyISAM AUTO_INCREMENT=23189 DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;
...
) ENGINE=MyISAM AUTO_INCREMENT=45381 DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;
